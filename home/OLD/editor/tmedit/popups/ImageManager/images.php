...
//		$refresh_dirs = true;
	...
	function show_file ($info, $img_url, $file, $filesize, $ext, $imgext) {
		if (is_array($info) && $info[0] > 0) {
			if ($ext == "SWF") {
			?>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="70" height="70">
                <param name="movie" value="<?php echo $img_url; ?>" />
                <param name="quality" value="high" />
                <embed src="<?php echo $img_url; ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="70" height="70"></embed>
              </object>
            <?php
			}
			else {
			?>           
		<img src="<?php echo $img_url; ?>" <?php if ($info[0] > $info[1]) echo " width='90'"; else echo " height='90'"; ?> alt="<?php echo $file; ?> - <?php echo $filesize; ?>" border="0" onClick="javascript:imageSelected('<?php echo $img_url; ?>', <?php echo $info[0];?>, <?php echo $info[1]; ?>,'<?php echo $file; ?>');">
            <?php
			}
		}
		else {
		?>
        <img src="<?php echo $imgext[$ext]; ?>" width="32" height="32" alt="<?php echo $file; ?> - <?php echo $filesize; ?>" border="0" onClick="javascript:imageSelected('<?php echo $img_url; ?>', <?php echo $info[0];?>, <?php echo $info[1]; ?>,'<?php echo $file; ?>');">
        <?php
		}
	}
	...
	<table width="102" border="0" cellpadding="0" cellspacing="2">
	  <tr> 
	    <td align="center" valign="middle" class="imgBorder" onMouseOver="pviiClassNew(this,'imgBorderHover')" onMouseOut="pviiClassNew(this,'imgBorder')" onClick="javascript:imageSelected('<?php echo $img_url; ?>', <?php echo $info[0];?>, <?php echo $info[1]; ?>,'<?php echo $file; ?>');">
		<?php
		show_file($info, $img_url, $file, $filesize, $ext, $imgext);
		?>
		</td>
	  </tr>
	  <tr>
