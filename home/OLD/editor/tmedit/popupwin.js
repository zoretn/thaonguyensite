...
function PopupWin(editor, title, handler, initFunction) {
	...
	html += "<style type='text/css'>@import url(" + _editor_url + "tmedit.css);</style></head>\n";
	html += "<body class='dialog popupwin' id='--TME-body' onload='self.focus();' onunload='opener.focus();'></body></html>";
	doc.write(html);
	doc.close();
