...
class content {
	...
	function Fill ($strwhere, $count, $begin=0) {
		...
		$strsql .= " ORDER BY lastupdate DESC, iorder DESC, id";
	...
	function Out_Image ($maxwidth) {
		...
		?>
		<img align="left" src="<?php echo $imgsrc; ?>" width="<?php echo $scalewidth; ?>" align="<?php echo $positionimg; ?>" class="<?php echo ($positionimg=="right")?"right":"left"; ?>"  />
		<?php
	}
