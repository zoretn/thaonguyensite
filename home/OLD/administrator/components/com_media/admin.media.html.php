				...
				<fieldset>
					...
					<tr>
						<td align="center" bgcolor="white">
							<div class="manager">
								<iframe height="360" src="media.php?task=list&listdir=<?php echo $listdir?>" name="imgManager" id="imgManager" width="100%" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0"></iframe>
							</div>
						</td>
					</tr>
					</table>
