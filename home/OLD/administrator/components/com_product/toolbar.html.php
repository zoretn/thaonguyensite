...
<tr>
	...
	<div class="pathway"><a href="index.php"><strong>Phan Nguyen</strong></a> / <a href="index.php?module=com_product">com_products</a>/<?php echo $task; ?></div>
	</td>
...
<tr>
	<td class="menudottedline" width="40%">
	<div class="pathway"><a href="index.php"><strong>Phan Nguyen</strong></a> / com_product</div>
	</td>
	<td class="menudottedline" align="right">
				<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
		<tr valign="middle" align="center">
