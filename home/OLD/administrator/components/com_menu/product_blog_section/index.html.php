...
$menutitle_cn = "";
$describe = "";
$menuurl = "index.php?module=com_product&task=blogsection&id=";
$menumenutype = -1;
$currentid = -1;
if (isset($_GET['id'])) {
	$menuid = $_GET['id'];
...
<div align="center" class="centermain">
	<div class="main">
		...
		<tr>
			<th>
			<?php echo ($menuid > -1) ? 'Edit' : 'Add';?> Menu Item :: Blog - Product Section
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
			  		...
			  		Product Section:			  		</td>
			 		<td>
					<select name="sid" size="10" class="inputbox" id="sid" onchange="this.form.url_menuitem.value = 'index.php?module=com_product&task=blogsection&id=' + this.value;" >
					...
					if (is_array($arrayproductsection)) {
						foreach ($arrayproductsection as $objproductsection) {
					?>
					<option value="<?php echo $objproductsection->id; ?>" ><?php echo $objproductsection->title; ?> (<?php echo $objproductsection->describe; ?>)</option>
					<?php
						}
					}
					?>
		...
		<input name="type_menuitem" type="hidden" id="type_menuitem" value="product_blog_section">
