...
$menutitle_cn = "";
$describe = "";
$menuurl = "index.php?module=com_product&task=blogcategory&id=";
$menumenutype = -1;
$currentid = -1;
if (isset($_GET['id'])) {
	$menuid = $_GET['id'];
...
<div align="center" class="centermain">
	<div class="main">
		...
		<tr>
			<th>
			<?php echo ($menuid > -1) ? 'Edit' : 'Add';?> Menu Item :: Blog - Product Category
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
			  		...
			  		Product Category:			  		</td>
			 		<td>
					<select name="catid" size="10" class="inputbox" id="catid" onchange="this.form.url_menuitem.value = 'index.php?module=com_product&task=blogcategory&id=' + this.value;" >
					...
					?>
					<option value="<?php echo $objproductcategory->id; ?>" ><?php echo $objproductcategory->title; ?> (<?php echo $objproductcategory->describe; ?>)</option>
					<?php
						}
					}
					?>
