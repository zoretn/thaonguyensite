...
$menutitle_cn = "";
$describe = "";
$menuurl = "index.php?module=com_faq";
$menumenutype = -1;
$currentid = -1;
if (isset($_GET['id'])) {
	$menuid = $_GET['id'];
...
<div align="center" class="centermain">
	<div class="main">
		...
		<tr>
			<th>
			<?php echo ($menuid > -1) ? 'Edit' : 'Add';?> Menu Item :: Component - FAQ </th>
		</tr>
		</table>
		...
		<input name="type_menuitem" type="hidden" id="type_menuitem" value="com_faq">
