...
<div align="center" class="centermain">
	<div class="main">
		...
		<tr>
			<th>
			<?php echo ($menuid > -1) ? 'Edit' : 'Add';?> Menu Item :: Link Url</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					...
					<td>
					<input name="url_menuitem" type="text" class="inputbox" id="url_menuitem" value="<?php echo $menuurl; ?>" size="30" maxlength="100" /></td>
				</tr>			
				<tr>
					<td colspan="2">&nbsp;</td>
				</tr>
		...
		<input name="type_menuitem" type="hidden" id="type_menuitem" value="url">
		</form>
</div></div>