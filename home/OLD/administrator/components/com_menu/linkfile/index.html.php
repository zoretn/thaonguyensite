...
<div align="center" class="centermain">
	<div class="main">
		...
		<tr>
			<th>
			<?php echo ($menuid > -1) ? 'Edit' : 'Add';?> Menu Item :: Parent Item </th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					...
					<td><input name="url_menuitem" type="text" class="text_area" id="url_menuitem" value="<?php echo $menuurl; ?>" size="30" maxlength="255"  />
				  <input name="button" type="button" onclick="openBox(750,500,'no','no',0,0,'../editor/tmedit/popups/insert_image_en.php?txt=url_menuitem&sorturl=0', window);" value=" ... " /></td>
				</tr>			
				<tr>
					<td colspan="2">&nbsp;</td>
				</tr>
		...
		<input name="type_menuitem" type="hidden" id="type_menuitem" value="linkfile" />
