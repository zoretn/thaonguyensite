...
$menutitle_cn = "";
$describe = "";
$menuurl = "index.php?module=com_content&task=blogcategory&id=";
$menumenutype = -1;
$currentid = -1;
if (isset($_GET['id'])) {
	$menuid = $_GET['id'];
...
<div align="center" class="centermain">
	<div class="main">
		...
		<tr>
			<th>
			<?php echo ($menuid > -1) ? 'Edit' : 'Add';?> Menu Item :: Blog - Content Category
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
			  		...
			  		Category:			  		</td>
			 		<td>
					<select name="catid" size="10" class="inputbox" id="catid" onchange="this.form.url_menuitem.value = 'index.php?module=com_content&task=blogcategory&id=' + this.value;" >
					...
					?>
					<option value="<?php echo $objcategory->id; ?>" ><?php echo $objcategory->title; ?> (<?php echo $objcategory->describe; ?>)</option>
					<?php
						}
					}
					?>
