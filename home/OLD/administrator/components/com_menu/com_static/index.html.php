...
$menutitle_cn = "";
$describe = "";
$menuurl = "index.php?module=com_static&id=";
$menumenutype = -1;
$currentid = -1;
if (isset($_GET['id'])) {
	$menuid = $_GET['id'];
...
<div align="center" class="centermain">
	<div class="main">
		...
		<tr>
			<th>
			<?php echo ($menuid > -1) ? 'Edit' : 'Add';?> Menu Item :: Link - Static Content</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					...
					<td width="200px"><input name="title_menuitem" type="text" class="inputbox" id="title_menuitem" value="<?php echo $menutitle; ?>" size="30" maxlength="100" /></td>
				  </tr>
				<tr>
				...
				<tr>
				  <td valign="top" align="right">Parent </td>
				...
				<tr>
			  		...
			  		Static Content:			  		</td>
			 		<td><select name="static" size="10" class="inputbox" id="static" onchange="document.adminForm.url_menuitem.value = 'index.php?module=com_static&id=' + this.value;" >
					<option value="-1" selected="selected">-Select statict content-</option>
                      <?php
					include_once ("../class/cstaticcontent.php");
					$arraystaticcontent = $objstaticcontent->Doc_danh_sach();
					if (is_array($arraystaticcontent)) {
						foreach ($arraystaticcontent as $objstaticcontent) {
					?>
                      <option value="<?php echo $objstaticcontent->id; ?>" ><?php echo $objstaticcontent->title; ?> (<?php echo $objstaticcontent->describe; ?>)</option>
                      <?php
						}
					}
					?>
		...
		<input name="type_menuitem" type="hidden" id="type_menuitem" value="com_static">
