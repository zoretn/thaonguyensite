...
$menutitle_cn = "";
$describe = "";
$menuurl = "index.php?module=com_content&task=blogsection&id=";
$menumenutype = -1;
$currentid = -1;
if (isset($_GET['id'])) {
	$menuid = $_GET['id'];
...
<div align="center" class="centermain">
	<div class="main">
		...
		<tr>
			<th>
			<?php echo ($menuid > -1) ? 'Edit' : 'Add';?> Menu Item :: Blog - Content Section
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
			  		...
			  		Section:			  		</td>
			 		<td>
					<select name="sid" size="10" class="inputbox" id="sid" onchange="this.form.url_menuitem.value = 'index.php?module=com_content&task=blogsection&id=' + this.value;" >
					...
					if (is_array($arraysection)) {
						foreach ($arraysection as $objsection) {
					?>
					<option value="<?php echo $objsection->id; ?>" ><?php echo $objsection->title; ?> (<?php echo $objsection->describe; ?>)</option>
					<?php
						}
					}
					?>
		...
		<input name="type_menuitem" type="hidden" id="type_menuitem" value="content_blog_section">
